...
namespace comp {
    ...
    DEFINE_24BIT_INSTRUCTION    (SWAP,0x40, 0x4000)
    ...
    DEFINE_24BIT_INSTRUCTION    (JMPT, 0x56, 0x3800);
    DEFINE_24BIT_INSTRUCTION    (JZ, 0x56, 0x2000);
    DEFINE_24BIT_INSTRUCTION    (JNZ, 0x56, 0x1800);
    DEFINE_24BIT_INSTRUCTION    (JNEG, 0x56, 0x1000);
    DEFINE_24BIT_INSTRUCTION    (JPOS, 0x56, 0x0800);
