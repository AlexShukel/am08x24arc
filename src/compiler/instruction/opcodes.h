...
namespace comp {
    ...
    DEFINE_INSTRUCTION            (JEA,     0x1A);
    DEFINE_INSTRUCTION            (JNZA,    0x1B);
    DEFINE_ARGLESS_INSTRUCTION    (JNZ,     0x1C);
    DEFINE_INSTRUCTION            (JNEA,    0x1D);
    DEFINE_INSTRUCTION            (JNEGA,   0x1E);
    DEFINE_ARGLESS_INSTRUCTION    (JNEG,    0x1F);
    DEFINE_INSTRUCTION            (JPOSA,   0x20);
    DEFINE_ARGLESS_INSTRUCTION    (JPOS,    0x21);

    DEFINE_INSTRUCTION            (DEVICE,  0x23);
    DEFINE_ARGLESS_INSTRUCTION    (DEVICET, 0x24);
